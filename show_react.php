<?php
	...
	if(isset($_GET['id']) && isset($_GET['type'])){		
		...
		$reacts = $Publish->get_reacts($_GET['id'], $_GET['type']);
	}else{

		$ERROR = "Unfortunately, no data can be found.";
	}
...
<!DOCTYPE html>
	...
	<head>
		...
		<style type="text/css">
			@import url('https://fonts.googleapis.com/css2?family=Oleo+Script&family=Roboto+Slab:wght@300&display=swap');
			...
			<div style="display: flex;">
				...
				<div style="min-height:400px; flex: 2.5; padding: 20px; padding-right: 0px; ">
					 ...
					 <div style="border: solid 2px white; padding: 10px; background-color: white">
				 			...
				 			<h2 style="font-weight: bolder; margin-top: -5px;">Buddies </h2>
