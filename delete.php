<?php
	...
	if($_SERVER['REQUEST_METHOD'] == "POST"){
		...
		$Publish->delete_post($_POST['post_id']);
...
<!DOCTYPE html>
	...
	<body style="font-family: 'Roboto Slab' ; background: linear-gradient(to right, #f1f2b5, #135058);">
		...
		<!-- Cover top bar-->
		<div style="width: 900px; margin:auto; min-height: 200px;">
			...
			<div style="display: flex;">
				...
				<div style="min-height:400px; flex: 2.5; padding: 20px; padding-right: 0px; ">
					 ...
					 <div style="border: solid 2px white; padding: 10px; background-color: white">
				 			...
				 			<h2 style="font-weight: bolder; margin-top: -5px;">Delete Post</h2>
										...
										if($ERROR != ""){
											...
											echo $ERROR;
					 						...
					 						echo "<input type='hidden' name='post_id' id='publish_btn' value='$row[post_id]'>";
					       					echo "<input type='submit' id='publish_btn' value='Delete'>";
				 						}
				 					 ?>
				 				<hr>
